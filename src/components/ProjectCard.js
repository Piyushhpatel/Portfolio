    ...
    <>
      <CardContainer>
        <CardBody className="relative group/card hover:shadow-2xl hover:shadow-emerald-500/[0.1] border-white/[0.2] w-auto h-auto rounded-xl p-6 border">
          <CardItem translateZ="10" rotateX={2} rotateZ={-2} className="w-full mt-2">
            <img
              src={thumbnail}
          ...
          <CardItem translateZ="50" className="text-[18px] mt-4 font-bold text-white/80">
            {name}
          </CardItem>
          <CardItem
            translateZ={20}
      ...
      >
        ...
        >
          <div
            className="overflow-y-auto max-w-[900px] w-full max-h-[80vh] rounded-xl bg-[#0C162D]/75 backdrop-blur-md border py-5 px-10 border-white/80"
          ...
          >
            ...
            <div className="space-y-4 text-center lg:text-start">
              ...
              <div className="space-x-4">
                {link && (
                  <Link href={link} target="_blank" className="text-[#E88DFF] hover:underline">
                    Live Website
                  </Link>
                )}
