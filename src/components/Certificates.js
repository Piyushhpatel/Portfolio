  ...
  return (
    ...
    >
      <div className="flex flex-col max-w-screen w-full h-full bg-[#0C162D] rounded-[12px] backdrop-blur-sm py-6 px-[20px]">
        <h2 className="text-white text-[32px] font-normal underline leading-[48px]">
          Certificates
        </h2>
        <div className="flex flex-wrap mt-2 max-auto gap-6 w-full items-center justify-center">
