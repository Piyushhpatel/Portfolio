...
const SkillBubble = ({name, icon}) => {
  ...
  return (
    <div className="relative flex flex-col">
      {isHover && <div className="text-white/75 transition-all duration-500  border border-white/70 rounded-lg py-2 px-6 absolute -left-5 -top-14 z-10 bg-black">{name}</div>}
      <div
