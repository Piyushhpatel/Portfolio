...
const Skills = () => {
  return (
    <div id="skills" className="z-10 max-w-[1024px] lg:max-h-[600px] w-full  bg-gradient-to-t from-[#E88DFF] to-[#2DBFFE] p-[3px] rounded-[15px]">
      ...
      <div>
        ...
        {
          SkillsData.map((skill) => <SkillBubble id={skill.id} name={skill.name} icon={skill.icon} />)
        }
        </div>
      </div>
    </div>
